          ...
          <div className="mx-4 md:text-lg max-w-screen-md">
            <article>
              ...
              <ul className="font-normal text-testDark pl-4">
                ...
                <li className="leading-relaxed">
                  Kinera&rsquo; development team, Parity Technology employees and any other person employed
              ...
              <ul className="font-normal text-testDark pl-4">
                ...
                <li className="leading-relaxed">
                  Don&rsquo;t defraud, harm, or violate the privacy of Kinera Ltd or its users during your
              ...
              <p>Bug Bounty Hunter Program rewards are at the sole discretion of Kinera. </p>
              <ul className="font-normal text-testDark pl-4">
                <li className="leading-relaxed">
              ...
              <p>
                ...
                the Program at any time and awards are at the sole discretion of Kinera development team.
