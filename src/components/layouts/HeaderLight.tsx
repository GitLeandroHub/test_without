...
import kineraLogoDark from '../../images/kinera-logo-2.png';
...
const socialLinksDiv = 'flex justify-center items-center px-2 py-1 my-4 lg:my-0';
      ...
      <div className="flex items-center justify-between px-4 py-3 lg:p-0 ">
        <div>
          <LocalizedLink to="/blog">
            <img className="h-6" src={isOpen ? kineraLogoDark : kineraLogo} alt="Parity Logo" />
          </LocalizedLink>
        </div>
